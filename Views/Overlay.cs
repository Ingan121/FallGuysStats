    ...
    public partial class Overlay : Form {
        ...
        private void SetQualifyChanceLabel(StatSummary levelInfo) {
            ...
            switch (qualifySwitchCount % 2) {
                case 0:
                    lblQualifyChance.Text = $"{Resources.Strings.overlay_qualify}:";
                    ...
                    break;
                case 1:
                    lblQualifyChance.Text = $"{Resources.Strings.overlay_gold}:";
        ...
        private void SetPlayersLabel() {
            ...
            switch (playersSwitchCount % 2) {
                case 0:
                    lblPlayers.Text = $"{Resources.Strings.overlay_players}:";
                    lblPlayers.TextRight = lastRound?.Players.ToString();
                    break;
                case 1:
                    lblPlayers.Text = $"{Resources.Strings.overlay_ping}:";
        ...
        private void SetStreakInfo(StatSummary levelInfo) {
            ...
            switch (streakSwitchCount % 2) {
                case 0:
                    lblStreak.Text = $"{Resources.Strings.overlay_win_streak}:";
                    lblStreak.TextRight = $"{levelInfo.CurrentStreak} ({levelInfo.BestStreak})";
                    break;
                case 1:
                    lblStreak.Text = $"{Resources.Strings.overlay_final_streak}:";
        ...
        private void UpdateInfo() {
            ...
            lock (StatsForm.CurrentRound) {
                ...
                if (lastRound != null && !string.IsNullOrEmpty(lastRound.Name)) {
                    ...
                    lblName.Text = $"{lastRound.Round}{Resources.Strings.overlay_round}:";
                    ...
                    if (lastRound.GameDuration > 0) {
                        lblDuration.Text = $"{Resources.Strings.overlay_time} ({TimeSpan.FromSeconds(lastRound.GameDuration):m\\:ss}):";
                    } else {
                        lblDuration.Text = $"{Resources.Strings.overlay_time}:";
                    }
